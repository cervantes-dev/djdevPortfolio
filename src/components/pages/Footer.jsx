...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-black overflow-hidden">
      ...
      {/* Match ContactMe background glow */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-950 opacity-60 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-purple-500/40 to-transparent" />
      ...
      {/* Cyan glow — matches ContactMe bottom right */}
      <div className="absolute top-0 -right-10 w-80 h-80 bg-cyan-400 opacity-5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          >
            {/* Badge style — matches ContactMe badge */}
            <span className="font-mono text-xs font-semibold tracking-widest uppercase border border-purple-500/40 bg-purple-500/10 px-4 py-1.5 rounded-full mb-2">
          ...
          >
            ...
            {/* Divider — matches ContactMe card border style */}
            <div className="w-full h-px bg-linear-to-r from-transparent via-purple-500/30 to-transparent" />

            {/* Copyright */}
            <p className="text-white/25 text-xs tracking-wide text-center font-mono">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="group relative flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs tracking-widest uppercase font-mono font-semibold bg-white/5 border border-purple-500/20 backdrop-blur-md transition-colors duration-300 hover:bg-purple-500/10 hover:border-purple-500/40"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
